...
export default {
  ...
  methods: {
    ...
    goToContactPage() {
      ...
      this.$router.push({ name: 'contact' }); // or '/contact' if you use paths
    },
  },
};
</script>
...
.logo {
  height: 80px; /* Increase the logo size */
  width: auto;
}
...
.navbar.scrolled .nav-link {
  color: #000000; /* Black color when scrolled */
}
...
.contact-btn {
  ...
  font-size: 1rem;
  font-weight: 400;
  padding: 0.5rem 1.5rem; /* Increase right padding */
